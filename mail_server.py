...
def save_mail(mail: List[Dict[str, str]]) -> None:
    ...
    This will save the mail entries consisiting of lists of dictionaries.
...
def add_mail(mail_entry: Dict[str, str]) -> str:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Adds the list of dictionaries called from load_mail() to another list. 
    This creates IDs that will be different in each mail entry and will be 
    saved by using save_mail().

    Returns: 
        A dictionary that consists of an ID representing new mail entry
...
def delete_mail(mail_id: str) -> bool:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This will delete any mail entry by iterating through the dictionary and 
    using .pop(), which can delete the element. Then, it saves the empty 
    dictionary using save_mail(). 

    Returns:
        A boolean denoting if each element in the mail dictionary was removed. 
...
def get_mail(mail_id: str) -> Optional[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This will get the mail by iterating through the dictionary of mail and returns
    each entry
    
    Returns:
        A dictionary of key and value pairs for each element in the dictionary 
...
def get_inbox(recipient: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Gets content of the mail inbox by creating an empty array then iterating 
    through each entry in the mail dictionary and appending it to the empty 
    array if it is labelled as a recipient.
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Gets list of emails that have been sent by creating an empty array then 
    iterating through each entry in the mail dictionary and appending it to 
    the empty array if it is labelled as a sender. 
...
def get_all_mail(recepient: str):
    """
    Summary: Gets all mail entries for a recipient from the json file
